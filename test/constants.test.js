...
describe('constants exports', () => {
  ...
  it('exports DS_KEYS with all required store keys', () => {
    ...
    assert.equal(constants.DS_KEYS.LOGS, 'kwtsms_logs');
  });
  ...
  it('exports SMS_EVENT with all event types', () => {
    ...
    assert.equal(constants.SMS_EVENT.GATEWAY_TEST, 'gateway_test');
  });
  ...
  it('exports DEFAULT_SETTINGS with correct defaults', () => {
    ...
    assert.equal(ds.default_country_code, '965');
  });
  ...
  it('exports all 11 named exports', () => {
    const expectedKeys = [
